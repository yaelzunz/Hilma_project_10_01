...
function Article() {
    ...
    const handleOnClick = () => {
        setTemp(!temp)
        const text = articleData.content.split(' ')
    ...
    return (
        <div className={styles["Article"]}>
         ...
         <section>
            <button onClick={() => navigate(`/questions/${title.replace(/[^a-zA-Z0-9 ]/g, '')}`)}>click to try</button>
        </section>
        <section>
...
<button onClick={() => {handleOnClick()}}> <CiBullhorn /></button>
        </div>
    )
}
